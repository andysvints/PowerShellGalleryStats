      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#e2f0fb; border-radius:6px; padding:24px;">
        ...
        <tr>
          <td style="font-size:12px; color:#6b7280;" align="center">
            ...
            <a href="https://stats.psfundamentals.com/unsubscribe?email=$email&module=$moduleid">Unsubscribe</a>
          </td>
        </tr>
      </table>
    </td>
...
https://stats.psfundamentals.com/unsubscribe?email=$email&module=$moduleid
