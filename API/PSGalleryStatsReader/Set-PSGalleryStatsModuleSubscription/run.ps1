...
$entity = $storageTable.TableClient.GetEntity[Azure.Data.Tables.TableEntity]($partitionKey, $rowKey, $null, $ct)
...
$storageTable.TableClient.UpdateEntity[Azure.Data.Tables.TableEntity]($entity,$entity.Value.ETag, $updateMode, $ct)
